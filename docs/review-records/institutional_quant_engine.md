# institutional_quant_engine review record
...
- `avellaneda2008`: Market-making attribution.
- `kalman1960`: Kalman filtering and dynamic state-estimation attribution.
- `repo_institutional_quant_engine`: Primary repository attribution for Institutional-Quant-Engine atoms.
- `nelsen2006copulas`: Copula dependence modeling attribution.
- `coles2001evt`: EVT and generalized Pareto tail modeling attribution.
- `hawkes1971`: Foundational Hawkes self-exciting point-process attribution.
- `heston1993`: Heston stochastic-volatility model attribution.
- `lopezdeprado2016hrp`: Hierarchical Risk Parity attribution.
- `cont2014ofi`: Order-flow imbalance and order-book event attribution.
