...
from sciona.ghost.abstract import AbstractArray, AbstractDistribution, AbstractMCMCTrace, AbstractRNGState, AbstractScalar, AbstractSignal, ANYTHING

def witness_sample_hawkes_event_trajectory(
    target: AbstractDistribution,
    trace: AbstractMCMCTrace,
    rng: AbstractRNGState,
    horizon: AbstractScalar,
